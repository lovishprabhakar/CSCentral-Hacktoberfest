...
export class SubsequentWeatherForecastPage extends BasePage {
  url = process.env.local ? '/Code/location.html' : '/CS-Central/Code/location.html';
  targetUrl = process.env.local ? '/Code/currentweather.html' : '/CS-Central/Code/currentweather.html';
